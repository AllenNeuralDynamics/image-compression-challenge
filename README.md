...
A submission must successfully pass all three validation checks in Step 1 to proceed to being scored in Step 2. Submissions that fail any validation check will not receive a score.
